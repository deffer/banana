<div quick-add suggested-bookmark="suggestedBookmark"
     name="quickAddBlock1" collapse="addBookmarkCollapsed">
	...
	<div class="controls control-row">
		<label class="control-label span1" for="inputName">Name {{inputUrl}}</label>
		<input class="span3" type="text" id="inputName" placeholder="Name" ng-model="inputTitle"/>
	</div>

	<div class="controls control-row" style="margin-bottom:10px;" ng-show="'a' == 'b'">
